...
interface TestimonialCardFourteenProps {
...
const TestimonialCard = memo(({
    ...
    return (
        <div className={cls("relative h-full card rounded-theme-capped p-6 flex flex-col justify-between gap-16", cardClassName)}>
...
TestimonialCardFourteen.displayName = "TestimonialCardFourteen";

export default memo(TestimonialCardFourteen);
