...
export const metadata: Metadata = {
  title: "Flamingo - Premium Fine Dining Restaurant",
  description: "Experience exquisite fine dining at Flamingo. Elegant atmosphere, expert cuisine, and impeccable service. Reserve your table today.",
  keywords: "fine dining restaurant, gourmet cuisine, reservation, elegant dining",
  metadataBase: new URL("https://flamingo-restaurant.com"),
  alternates: {
    canonical: "https://flamingo-restaurant.com"
  },
  openGraph: {
    title: "Flamingo - Premium Fine Dining",
    description: "Experience exquisite fine dining at Flamingo",
    url: "https://flamingo-restaurant.com",
    siteName: "Flamingo Restaurant",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1765535476930-5ojkgd9s.jpg",
        alt: "Flamingo Restaurant"
      }
    ]
  },
  twitter: {
    ...
    title: "Flamingo - Premium Fine Dining",
    description: "Experience exquisite fine dining at Flamingo",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1765535476930-5ojkgd9s.jpg"]
  },
  robots: {
    index: true,
    follow: true
